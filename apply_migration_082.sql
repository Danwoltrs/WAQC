-- Apply this SQL in Supabase SQL Editor to fix enum type casting error
...
SELECT 'Migration 082: Fixed sample_type enum comparison - APPLIED SUCCESSFULLY!' as status;
